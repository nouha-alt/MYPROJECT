...
<title>SnapStore - Registration</title>
...
<section>
    <div class="container">
        <div class="row full-screen align-items-center">
         ...
         <input type="text" class="form-style" name="Name" placeholder="Your Name" autocomplete="off" required>
         <i class="input-icon material-icons">perm_identity</i>
         </div>
        <div class="form-group">
          <input type="email" class="form-style" name="email" placeholder="Your Email" autocomplete="off" required>
